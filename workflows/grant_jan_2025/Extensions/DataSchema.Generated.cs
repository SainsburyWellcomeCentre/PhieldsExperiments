...
namespace DataSchema
{
    ...
    public partial class Environment
    {
        ...
        private double _timeInLoomAreaThreshold = 0.5D;
        ...
        protected Environment(Environment other)
        {
            ...
            _timeInLoomAreaThreshold = other._timeInLoomAreaThreshold;
        }
        ...
        /// <summary>
        /// Specifies Angle between mouse and loom for loom to be triggered
        /// </summary>
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="angleThreshold")]
        [System.ComponentModel.DescriptionAttribute("Specifies Angle between mouse and loom for loom to be triggered")]
        ...
        /// <summary>
        /// Specifies minimum time without looms after a loom
        /// </summary>
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="refractoryPeriodSeconds")]
        [System.ComponentModel.DescriptionAttribute("Specifies minimum time without looms after a loom")]
        ...
        /// <summary>
        /// Specifies threshold time for subject to be within specified loom region for loom to be triggered
        /// </summary>
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="timeInLoomAreaThreshold")]
        [System.ComponentModel.DescriptionAttribute("Specifies threshold time for subject to be within specified loom region for loom " +
            "to be triggered")]
        public double TimeInLoomAreaThreshold
        {
            get
            {
                return _timeInLoomAreaThreshold;
            }
            set
            {
                _timeInLoomAreaThreshold = value;
            }
        }
        ...
        protected virtual bool PrintMembers(System.Text.StringBuilder stringBuilder)
        {
            ...
            stringBuilder.Append("timeInLoomAreaThreshold = " + _timeInLoomAreaThreshold);
            return true;
        }
